  ...
  return (
    <div className="min-h-screen bg-white p-10 font-sans text-zinc-900">
      ...
      {(rooms ?? []).map((room: any) => {
        ...
        const roomApproved = materials.filter((m) => m.status === "Approved").reduce((s: number, m: any) => s + Number(m.estimated_cost), 0);
      ...
      {/* Footer */}
      <div className="mt-12 pt-6 border-t border-zinc-200 text-xs text-zinc-400 flex justify-between print:fixed print:bottom-8 print:left-10 print:right-10">
